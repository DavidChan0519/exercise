...
Wine::Wine(const char *l, int y):label(l),years(y),data(ArrayInt(0,y),ArrayInt(0,y))
{
}
Wine::Wine(const char *l, const Wine::PairArray &yr_bot):label(l),years(yr_bot.first().size()),data(yr_bot)
{
}
...
void Wine::GetBottles()
{
	if(years<1)
	{
		cout<<"No space allacated for data\n";
		return;
	}
